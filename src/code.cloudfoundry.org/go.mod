...
replace (
	...
	// pin kube-openapi to the version k8s.io/apimachinery v0.37.0 expects; a newer kube-openapi
	// returns structured-merge-diff/v7 types that don't match apimachinery's vendored v6 usage
